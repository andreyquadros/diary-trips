...
import '../services/firebase/database_operations.dart';
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              onPressed: () async {
                await DatabaseOperationsFirebase().createNewUserFirebase(context, _emailController.text, _passwordController.text);
